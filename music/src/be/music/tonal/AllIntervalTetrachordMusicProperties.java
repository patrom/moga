...
public class AllIntervalTetrachordMusicProperties {
	...
	//melody
	private double melodyConsDissValue = 0.1;//hoe lager, hoe cons - stapsgewijs
	...
	//tonality
	private int[] scale = Scale.ALL_INTERVAL_TRETRACHORD1;
